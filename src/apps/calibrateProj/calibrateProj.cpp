...
int main(int argc, char** argv)
{
    ...
    for (int numIm = 0; numIm < numIms; numIm++)
    {
        ...
        Homography::computeBirdsEyeViewVirtualProjAlignedWithVirtualCam(
            planes[numIm], cams[0], proj, verticalOffset, virtualCamR, virtualCamT, alignedVirtualProjR, alignedVirtualProjT);
